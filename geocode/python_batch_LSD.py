...
output_filename = 'data/output-LSDLocation.csv'
# Set your input file here
input_filename = "data/LSDLocations.csv"
...
test_result = get_google_results("04-16-031-15W", API_KEY, RETURN_FULL_RESULTS)
